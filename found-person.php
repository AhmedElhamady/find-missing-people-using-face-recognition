...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500;600;700;800&display=swap"
        rel="stylesheet" />
    <title>Report-person found</title>
</head>

<body>
    <?php include "partials/header.php" ?>
    <div class="found-text">
        <h1>Report a person found</h1>
    </div>
    <div class="found-content">
        ...
        <form action="upload-report-found.php" method="post" enctype="multipart/form-data">
            <div class="person-info">
                <p class="heading">Person found information</p>
                ...
                <div class="person-name box">
                    ...
                    <input type="text" placeholder="Person name" id="person-name" name="child-name"
                ...
                <div class="person-age box">
                    ...
                    <input type="text" placeholder="Person age" id="person-age" name="age"
            ...
            <div class="place-date">
                <p class="heading">The place and date the person was found</p>
                <div class="date">
            ...
            <div class="founder-info">
                ...
                <div class="founder-ssn box">
                    <label for="founder-ssn" class="title">SSN</label>
                    <input type="text" placeholder="SSN" maxlength="14" id="founder-ssn" name="ssn"
                        value="<?= $_SESSION['report-data']["ssn"] ?? "";
                                                                                                            unset($_SESSION["report-data"]["ssn"]) ?>" />
                </div>
